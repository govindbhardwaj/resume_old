...
export { Set };
export var CUSTOM_ELEMENT_FEATURE_TESTS = new Set([].concat(_toConsumableArray(COMPONENT_FEATURE_TESTS), ["template", "customelements"]));
var circutBreaker = null;
export var customElementMixin = function customElementMixin(C) {
  return (
    /*#__PURE__*/
    function (_C) {
      _inherits(_class, _C);
      ...
      function _class() {
        ...
        _this.setupComponent(_assertThisInitialized(_assertThisInitialized(_this)), _this.getStateFromAttributes());
